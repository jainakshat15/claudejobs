...
You get the command list back: `/run`, `/ask-sales-bot`, `/ask-od`, `/jobs`,
`/status`, `/log`, `/messages`, `/events`, `/reply`, `/cancel`, `/retry`, `/edit`,
`/stats`, `/health`, `/whoami`, `/help`. Then queue a real job:
